...
set title "Acceleration en fonction du nombre de threads pour $benchmark"
set xtics (1, 2, 4, 8, 16, 32, 64)
plot [0.9:70][0:$max] \
  "$fich" using 1:(\$2/\$3) title "methodePar1" with linespoints,\
  "$fich" using 1:(\$2/\$4) title "methodePar2" with linespoints
EOF
